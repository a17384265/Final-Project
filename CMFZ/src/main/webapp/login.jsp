    ...
    <form id="loginForm" action="${ pageContext.request.contextPath}/User/login.do" method="post">
        <table>
            ...
            <tr>
                ...
                <th>验证码:</th>
                <td>
                    <input type="text" id="Code" name="enCode" class="text captcha" maxlength="4" autocomplete="off"/>
                    <img alt="加载失败!" src="${pageContext.request.contextPath }/captcha/createCaptcha.do"
                         onclick="this.src='${pageContext.request.contextPath }/captcha/createCaptcha.do?'+ Math.random()"
                         id="codeImage">
                    <div id="div"><h6></h6></div>
                </td>
            </tr>
            <tr>
                <td>
